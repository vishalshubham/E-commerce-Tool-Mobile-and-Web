 ...
 * @author VISHAL
 */
public class RevenueGeneratedYearly extends HttpServlet {
    ...
    throws ServletException, IOException
    {
        ...
        request.getSession().setAttribute("RG_YEARLY_DATE", dailydate);
        request.getSession().setAttribute("RG_YEARLY", finalResult);
        ...
        response.sendRedirect("/MBA2/Manager/RevenueGeneratedYearlyResult.jsp");
