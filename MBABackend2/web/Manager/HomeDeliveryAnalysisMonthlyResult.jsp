<%-- 
    Document   : HomeDeliveryAnalysisMonthlyResult
    Created on : 3 May, 2011, 10:59:02 PM
    Author     : VISHAL
--%>
...
<%@page import="com.mba.manager.html.services.homedeliveryanalysis.HomeDeliveryAnalysisObject" %>
...
<table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Home Delivery : Monthly Report</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<%
            Map<String, HomeDeliveryAnalysisObject> c = (Map<String, HomeDeliveryAnalysisObject>)request.getSession().getAttribute("HDA_MONTHLY_OBJECT");
         ...
         <%
                ...
                <br>  <table width="750" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
                  <tr class="ItemHeading">
                     <td width="350" align="center">Way Of Communication : </td>
                    <td width="400" align="center">Total No. Of Transactions :</td>
                ...
                while(cset.hasNext())
                {
                    ...
                    HomeDeliveryAnalysisObject cc = c.get(key);
                    String way = cc.getWay();
                    String total = cc.getTotal();

                    %>
                    <center>
                    <tr>
                    <td align="center"><span class="ItemDetail"><%=way%></span></td>
                    <td align="center"><span class="ItemDetail"><%=total%></span></td>
                    </tr></center>
                    ...
                    <table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="ItemHeading"><h3>Graphical Representation : Monthly Home Delivery</h3></td>
                  </tr>
                </table>
                  <center>
     <img src="../../images/HomeDeliveryAnalysisMonthly/myimg.jpg" alt="Image 0" />
                  </center>
