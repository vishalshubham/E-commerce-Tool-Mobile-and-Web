<%-- 
    Document   : ProductSalesAnalysis
    Created on : 2 May, 2011, 2:35:56 PM
    Author     : VISHAL
--%>
...
<table width="800" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Categories Available for Product Analysis in our Supermarket :</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href='/MBA2/htmlproductsalesanalysismenu?category=<%= ct.get(i) %>' ><img src="images/category/<%= ct.get(i) %>.png" width="100" height="150" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href='/MBA2/htmlproductsalesanalysismenu?category=<%= ct.get(i) %>' ><%=  ct.get(i)  %></a></td>
  </tr>
</table>
    ...
    <body>
        ...
        <%
            for(int i=0; i < ct.size(); i++ )
                {
                    %>
                    <a href="/MBA2/htmlproductsalesanalysismenu?category=<%= ct.get(i) %>" ><%=  ct.get(i)  %>  </a>
                    <%
                }
        %>
