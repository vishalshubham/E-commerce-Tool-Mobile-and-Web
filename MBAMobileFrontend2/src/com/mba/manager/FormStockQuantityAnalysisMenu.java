 ...
 * @author VISHAL
 */
public class FormStockQuantityAnalysisMenu implements CommandListener
{
    ...
    {
        FormStockQuantityAnalysisMenu fm = new FormStockQuantityAnalysisMenu();
    ...
    public void commandAction(Command c, Displayable d)
    {
            if(c==List.SELECT_COMMAND)
            {
                ...
                String result1 = sendStockQuantityAnalysisDaily(item);
                if(result1 != null)
                {
                    fresult = FormStockQuantityAnalysisResult.getFormStockQuantityAnalysisDailyResult(result1);
    ...
    private String sendStockQuantityAnalysisDaily(String category)
    {
        try
        {
            ...
            HttpConnection con = (HttpConnection) Connector.open("http://localhost:8090/MBA2/MainHandler?serviceid=30&requestsourceid=1&category="+ category + "&username="+FormLogin.getUserName()+ "&date="+spacedate);
            dis = new DataInputStream(con.openInputStream());
