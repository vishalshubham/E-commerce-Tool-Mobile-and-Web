...
public class AxisCharts extends UserGuideBase
{
	...
	******************************************************************************************/
	...
	private void horizontalPlots() throws ChartDataException
	{
		...
		super.exportImage( axisChart, "img/horizontalPlots" );
	}
	...
	private void rounding() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/axisRounding" );
	}
	...
	private void userDefinedScale() throws ChartDataException, PropertyException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/userDefinedScale" );
	}
...
//todo what about ScaleCalculator implementations?
	...
	private void numberOfItemsOnYAxis() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/numberOfItemsOnYAxis" );
	}
	...
	private void gridLines() throws ChartDataException
	{
		...
		AxisChart axisChart= new AxisChart( dataSeries, new ChartProperties(), axisProperties, new LegendProperties(), width, height );
		super.exportImage( axisChart, "img/gridLines" );
	}
	...
	private void dollarSigns() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/dollarSigns" );
	}
	...
	private void commas() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/commas" );
	}
	...
	private void axisBackgroundPaint() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/axisBackground" );
	}
	...
	private void axisTitles() throws ChartDataException
	{
		...
		super.exportImage( axisChart, "img/axisTitles" );
		...
		super.exportImage( axisChart, "img/axisTitleFont" );
	}
	...
	private void zeroLine() throws ChartDataException, PropertyException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/noZeroLine" );
		...
		super.exportImage( this.getChart( axisProperties ), "img/zeroLinePaintStroke" );
	}
	...
	private void scaleFont() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/scaleFont" );
	}
	...
	private void verticalXAxisLabels() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/verticalXAxisLabels" );
	}
	...
	private void tickMarks() throws ChartDataException
	{
		...
		super.exportImage( this.getChart( axisProperties ), "img/ticksWithLabels" );


		axisProperties= new AxisProperties();
		axisProperties.getXAxisProperties().setShowTicks( AxisTypeProperties.TICKS_NONE );
		super.exportImage( this.getChart( axisProperties ), "img/noTicks" );
		...
		super.exportImage( this.getChart( axisProperties ), "img/tickColors" );
		...
		super.exportImage( this.getChart( axisProperties ), "img/tickStroke" );
	}
