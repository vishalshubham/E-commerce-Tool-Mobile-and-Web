 ...
 * @author VISHAL
 */
public class NameUpdater extends HttpServlet {
        ...
        if(Integer.parseInt(reqsrc) == 1)
        {
            if(dBConnection != null)
            {
                try
                {
                    ...
                    System.out.print("Name Updater" + name + " _______ " + username);
                    response.reset();
                    response.resetBuffer();
                    boolean rs = dBConnection.runUpdateQuery("Update_User_Name", new String[]{name,username});
                    if(rs==true)
                    {
