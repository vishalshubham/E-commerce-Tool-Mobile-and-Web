<%-- 
    Document   : ProductSalesAnalysisYearly
    Created on : 2 May, 2011, 10:53:10 PM
    Author     : VISHAL
--%>
...
<form action="/MBA2/htmlproductsalesanalysisyearly">
           <input type="hidden" id="serviceid" name="serviceid" value="26"/>
