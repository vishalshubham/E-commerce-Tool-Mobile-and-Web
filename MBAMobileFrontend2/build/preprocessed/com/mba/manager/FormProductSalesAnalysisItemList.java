 ...
 * @author VISHAL
 */
public class FormProductSalesAnalysisItemList implements CommandListener
{
    ...
    {
        fmenu=new List("Your Item List:",List.IMPLICIT);
    ...
    {
        FormProductSalesAnalysisItemList fm = new FormProductSalesAnalysisItemList();
    ...
    private String returnItemCategory()
    {
        ...
        {
            DataInputStream dis;
            System.out.println("this is our category" + FormProductSalesAnalysisMenu.item);
            HttpConnection con = (HttpConnection) Connector.open("http://localhost:8090/MBA2/ItemList?requestsourceid=1&category="+FormProductSalesAnalysisMenu.item);
    ...
    public void commandAction(Command c, Displayable d)
    {
            if(c==List.SELECT_COMMAND)
            {
                ...
                formmenugroup = FormProductSalesAnalysisTimePeriod.getFormProductSalesAnalysisTimePeriod();
            ...
            {
                formhome = FormProductSalesAnalysisMenu.getFormMenu();
