<%--
    Document   : ChangeInfoAddressResult
    Created on : 21 March, 2011, 8:45:20 PM
    Author     : VISHAL
--%>
...
<table width="800" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Congratulations ! Your Address has been changed now.</h2></td>
  </tr>
</table>
<%
    }
...
<table width="800" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Please Enter Valid Information. Special characters and empty spaces not allowed</h2></td>
  </tr>
</table>
