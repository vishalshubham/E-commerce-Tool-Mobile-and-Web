 ...
 * @author VISHAL
 */
public class ProductSalesAnalysisYearly
{
    public static String productSalesAnalysisYearlyResult = "";
...
productSalesAnalysisYearlyResult = "";
        if(dBConnection != null)
        {
            try
            {
                ...
                ResultSet resultset = dBConnection.runQuery("Fetch_Product_Sales_Analysis_Yearly", new String[]{requestDataMap.get("item"), requestDataMap.get("category"), requestDataMap.get("dailydate")});

                while(resultset.next())
                {
                    productSalesAnalysisYearlyResult = productSalesAnalysisYearlyResult + resultset.getString("itemid") + "-" + resultset.getString("item_name") + "-" + resultset.getString("category") + "-" + resultset.getString("quantity") + "," ;
                }

                System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkkkk" + productSalesAnalysisYearlyResult);
