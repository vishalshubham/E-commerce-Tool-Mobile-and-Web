 ...
 * @author VISHAL
 */
public class RevenueGeneratedDaily extends HttpServlet {
    ...
    throws ServletException, IOException
    {
        ...
        request.getSession().setAttribute("RG_DAILY_DATE", dailydate);
        request.getSession().setAttribute("RG_DAILY", finalResult);
        ...
        response.sendRedirect("/MBA2/Manager/RevenueGeneratedDailyResult.jsp");
