<%-- 
    Document   : ProductSalesAnalysisDaily
    Created on : 2 May, 2011, 10:52:35 PM
    Author     : VISHAL
--%>
...
<form action="/MBA2/htmlproductsalesanalysisdaily">
           <input type="hidden" id="serviceid" name="serviceid" value="24"/>
           <input type="hidden" id="requestsourceid" name="requestsourceid" value="2"/>
           <input type="hidden" id="category" name="category" value="<%=session.getAttribute("PSA_CATEGORY")%>"/>
           <input type="hidden" id="item" name="item" value="<%=session.getAttribute("PSA_ITEM")%>"/>
...
<table width="750" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
  <tr class="ItemHeading" >
    <td width="200" align="center">Enter Year :</td>
  ...
  <tr class="ItemHeading" >
    <td width="200" align="center">Enter Month :</td>
  ...
  <tr class="ItemHeading" >
    <td width="200" align="center">Enter Date :</td>
