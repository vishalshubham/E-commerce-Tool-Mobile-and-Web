...
//        System.out.println("LOG $J CONFMDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD " );
//        File f = new File("XYXXXXXXXXX.txt");
//        System.out.println("FILE PATH  ::::::::: " + f.getAbsolutePath());
//        new FileOutputStream(f).write("dddddddddddddddddd".getBytes());
//
//
//
//        Logger logger = Logger.getLogger("service.log");
//        logger.debug("Inside the Login ");
           ...
           // System.out.println("000000000000");
            if(dBConnection != null)
            {
                try {
                        ...
                        System.out.println("passssssssssslllllllllllllllllllllll"+PasswordRetainer.getPassword());
