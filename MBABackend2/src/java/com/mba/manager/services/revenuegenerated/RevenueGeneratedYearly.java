 ...
 * @author VISHAL
 */
public class RevenueGeneratedYearly
{
    public static String revenueGeneratedYearlyResult = "";
...
revenueGeneratedYearlyResult = "";
        if(dBConnection != null)
        {
            try
            {
                System.out.println("I am in revenue generated Yearly Servlet");
                ...
                ts.setRequestType(35);

                String dd = ts.getTransaction_date_time();

                System.out.println(requestDataMap.get("dailydate")+": yearly date");

                ResultSet resultset = dBConnection.runQuery("Fetch_Revenue_Generated_Yearly", new String[]{requestDataMap.get("dailydate")});

                while(resultset.next())
                {
                    revenueGeneratedYearlyResult = revenueGeneratedYearlyResult + resultset.getString("total_revenue") + "," ;
                }

                System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkkkk" + revenueGeneratedYearlyResult);
