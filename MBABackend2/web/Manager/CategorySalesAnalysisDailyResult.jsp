<%--
    Document   : CategorySalesAnalysisDailyResult
    Created on : 2 May, 2011, 4:45:31 PM
    Author     : VISHAL
--%>
...
<%
            Map<String, CategorySalesAnalysisObject> c = (Map<String, CategorySalesAnalysisObject>)request.getSession().getAttribute("CSA_DAILY_OBJECT");
        ...
        <%
                ...
                while(cset.hasNext())
                {
                  ...
                  <center>
        <img src="../../images/CategorySalesAnalysisDaily/myimg.jpg" alt="Image 0" /></center>
