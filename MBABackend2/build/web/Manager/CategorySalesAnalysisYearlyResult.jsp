<%--
    Document   : CategorySalesAnalysisYearlyResult
    Created on : 2 May, 2011, 5:27:56 PM
    Author     : VISHAL
--%>
...
<%
            Map<String, CategorySalesAnalysisObject> c = (Map<String, CategorySalesAnalysisObject>)request.getSession().getAttribute("CSA_YEARLY_OBJECT");
        ...
        <%
                ...
                while(cset.hasNext())
                {
                  ...
                  <center>
                  <img src="../../images/CategorySalesAnalysisYearly/myimg.jpg" alt="Image 0" />
                  </center>
