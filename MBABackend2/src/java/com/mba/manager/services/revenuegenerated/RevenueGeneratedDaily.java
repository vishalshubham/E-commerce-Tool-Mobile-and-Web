 ...
 * @author VISHAL
 */
public class RevenueGeneratedDaily
{
    public static String revenueGeneratedDailyResult = "";
...
revenueGeneratedDailyResult = "";
        if(dBConnection != null)
        {
            try
            {
                System.out.println(" I am in revenue generated Daily Servlet");
                ...
                ResultSet resultset = dBConnection.runQuery("Fetch_Revenue_Generated_Daily", new String[]{requestDataMap.get("dailydate")});

                while(resultset.next())
                {
                    revenueGeneratedDailyResult = revenueGeneratedDailyResult + resultset.getString("total_revenue") + "," ;
                }

                System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkkkk" + revenueGeneratedDailyResult);
