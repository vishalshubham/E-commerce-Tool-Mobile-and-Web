<%--
    Document   : ChangeInfoContact
    Created on : 9 Mar, 2011, 11:18:40 PM
    Author     : VISHAL
--%>
...
<li class="parent"><a href="#"><span>Shopping</span></a>
        ...
        <li><a href="discount.html"><span>Discount Offers</span></a></li>
        <li><a href="ChangeInfo.html"><span>Change User Information</span></a>

		<ul>
                <li><a href="ChangeName.html">Change Name</a></li>
                <li><a href="ChangeAddress.html">Change Address</a></li>
                <li><a href="ChangeContact.html">Change Contact</a></li>
...
<table width="750" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
  <tr class="ItemHeading" >
    <td width="200" align="center">Enter New Mobile No. :</td>
    <td align="center"><input type="text" id="contact" name="contact" width="170"></td>
  </tr>
  <tr class="ItemHeading" >
    <td width="200" align="center">Enter Email id :</td>
    <td align="center"><input type="text" id="email" name="email" width="170px"></td>
  </tr>
                <input type="hidden" id="serviceid" name="serviceid" value="5"/>
...
<tr class="ItemHeading">
<td width="200" align="center">Change Contact:</td>
<td align="center"><input type="submit" value="       Edit Contact       "></form>
