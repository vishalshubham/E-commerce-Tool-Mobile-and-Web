 ...
 * @author VISHAL
 */
public class FormRevenueGenerated implements CommandListener
{
    ...
    private ChoiceGroup year3,month2,year2;
    ...
    {
        FormRevenueGenerated fc = new FormRevenueGenerated();
    ...
    private String sendRevenueGeneratedDaily(String dailyDate)
    {
        try
        {
            ...
            HttpConnection con = (HttpConnection) Connector.open("http://localhost:8090/MBA2/MainHandler?serviceid=33&requestsourceid=1&dailydate="+ dailyDate + "&username="+FormLogin.getUserName()+ "&date="+spacedate);
    ...
    private String sendRevenueGeneratedMonthly(String dailyDate)
    {
        ...
        try
        {
            ...
            System.out.println(spacedate + " : date is this-- "+"--"+dailyDate);
            HttpConnection con = (HttpConnection) Connector.open("http://localhost:8090/MBA2/MainHandler?serviceid=34&requestsourceid=1&dailydate="+ dailyDate + "&username="+FormLogin.getUserName()+ "&date="+spacedate);
            dis = new DataInputStream(con.openInputStream());
    ...
    private String sendRevenueGeneratedYearly(String dailyDate)
    {
        try
        {
            DateGetter d = new DateGetter();
            ...
            System.out.println(spacedate + " : date is this-- "+"--"+dailyDate);
            HttpConnection con = (HttpConnection) Connector.open("http://localhost:8090/MBA2/MainHandler?serviceid=35&requestsourceid=1&dailydate="+ dailyDate + "&username="+FormLogin.getUserName()+ "&date="+spacedate);
            dis = new DataInputStream(con.openInputStream());
    ...
    public void commandAction(Command c, Displayable d)
    {
        if(d==fdaily)
        {
            if(c==back1)
            {
                formtime = FormRevenueGeneratedTimePeriod.getFormRevenueGeneratedTimePeriod();
            ...
            else if(c==ok1)
            {
                ...
                String result1 = sendRevenueGeneratedDaily(dailyDate);
                if(result1 != null)
                {
                    fresult = FormRevenueGeneratedResult.getFormRevenueGeneratedDailyResult(result1);
                    MobileMidlet.switchDisplay(fresult);
                    FormRevenueGeneratedResult.typeOfRequest = "1";
                }
                else
                {
        ...
        else if(d==fmonthly)
        {
            ...
            else if(c==ok2)
            {
                ...
                String result1 = sendRevenueGeneratedMonthly(dailyDate);
                if(result1 != null)
                {
                    fresult = FormRevenueGeneratedResult.getFormRevenueGeneratedMonthlyResult(result1);
                    MobileMidlet.switchDisplay(fresult);
                    FormRevenueGeneratedResult.typeOfRequest = "2";
                }
                else
                {
                    Alert alert= new Alert("SORRY::","Some ERROR has been occured on the server",null,null);
        ...
        else if(d==fyearly)
        {
            ...
            else if(c==ok3)
            {
                ...
                String result1 = sendRevenueGeneratedYearly(dailyDate);
                if(result1 != null)
                {
                    fresult = FormRevenueGeneratedResult.getFormRevenueGeneratedYearlyResult(result1);
                    MobileMidlet.switchDisplay(fresult);
                    FormRevenueGeneratedResult.typeOfRequest = "2";
                }
                else
