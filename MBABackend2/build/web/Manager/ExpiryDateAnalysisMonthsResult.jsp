<%-- 
    Document   : ExpiryDateAnalysisMonthsResult
    Created on : 4 May, 2011, 12:51:58 AM
    Author     : VISHAL
--%>
...
<%@page import="com.mba.manager.html.services.expirydateanalysis.ExpiryDateAnalysisObject" %>
...
<%
            String category = (String)session.getAttribute("EDA_CATEGORY");
        %>
...
<table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2><%=category%> Category : Expiry Analysis : Monthly Report</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
 ...
 <%
            Map<String, ExpiryDateAnalysisObject> c = (Map<String, ExpiryDateAnalysisObject>)request.getSession().getAttribute("EDA_MONTHS_OBJECT");
        ...
        <%
                ...
                <br>  <table width="750" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
                  <tr class="ItemHeading">
                    ...
                    <td width="200" align="center">No. Of Days</td>
               ...
               while(cset.hasNext())
                {
                    ...
                    ExpiryDateAnalysisObject cc = c.get(key);
                    String itemId = cc.getItemid();
                    String itemName = cc.getItem_name();
                    String noOfDays= cc.getNoOfDays();
                    ...
                    <td align="center"><span class="ItemDetail"><%=noOfDays%></span></td>
                    </tr></center>
