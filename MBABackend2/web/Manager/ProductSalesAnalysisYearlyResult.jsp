<%-- 
    Document   : ProductSalesAnalysisYearlyResult
    Created on : 2 May, 2011, 11:34:26 PM
    Author     : VISHAL
--%>
...
<%@page import="com.mba.manager.html.services.productsalesanalysis.ProductSalesAnalysisObject" %>
...
<table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2><%=category%> Category : Yearly Report</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<%
            Map<String, ProductSalesAnalysisObject> c = (Map<String, ProductSalesAnalysisObject>)request.getSession().getAttribute("PSA_YEARLY_OBJECT");
        ...
        <%
                ...
                while(cset.hasNext())
                {
                    ...
                    ProductSalesAnalysisObject cc = c.get(key);
