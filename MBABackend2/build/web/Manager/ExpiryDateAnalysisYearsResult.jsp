<%-- 
    Document   : ExpiryDateAnalysisYearsResult
    Created on : 4 May, 2011, 12:52:08 AM
    Author     : VISHAL
--%>
...
<table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Expiry Analysis : <%=category%> Category : Yearly Report</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<%
            Map<String, ExpiryDateAnalysisObject> c = (Map<String, ExpiryDateAnalysisObject>)request.getSession().getAttribute("EDA_YEARS_OBJECT");
        ...
        <%
                ...
                {   %>
                  ...
                  <tr class="ItemHeading">
                    ...
                    <td width="200" align="center">No. Of Years</td>
