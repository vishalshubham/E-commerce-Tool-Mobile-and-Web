<%--
    Document   : CategorySalesAnalysisYearly
    Created on : 2 May, 2011, 3:18:05 PM
    Author     : VISHAL
--%>
...
<form action="/MBA2/htmlcategorysalesanalysisyearly">
           <input type="hidden" id="serviceid" name="serviceid" value="23"/>
