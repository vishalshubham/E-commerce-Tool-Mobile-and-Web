<%-- 
    Document   : ExpiryDateAnalysisDaysResult
    Created on : 4 May, 2011, 12:51:39 AM
    Author     : VISHAL
--%>
...
<table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2><%=category%> Category : Expiry Analysis : Daily Report</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<%
            Map<String, ExpiryDateAnalysisObject> c = (Map<String, ExpiryDateAnalysisObject>)request.getSession().getAttribute("EDA_DAYS_OBJECT");
       ...
       <%
                ...
                {   %>
                  ...
                  <tr class="ItemHeading">
                    ...
                    <td width="250" align="center">No. Of Days</td>
