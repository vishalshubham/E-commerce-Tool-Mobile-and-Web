<%-- 
    Document   : RevenueGeneratedMonthly
    Created on : 3 May, 2011, 12:00:57 AM
    Author     : VISHAL
--%>
...
<!-- Heading Table End -->
 ...
 <form action="/MBA2/htmlrevenuegeneratedmonthly">
           <input type="hidden" id="serviceid" name="serviceid" value="34"/>
