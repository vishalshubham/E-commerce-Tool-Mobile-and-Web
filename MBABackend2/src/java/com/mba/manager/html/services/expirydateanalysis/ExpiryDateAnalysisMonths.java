 ...
 * @author VISHAL
 */
public class ExpiryDateAnalysisMonths extends HttpServlet {
    ...
    throws ServletException, IOException
    {
        ...
        for(int i = 0 ; i < arrResult.length ; i++)
        {
            ...
            else if(arrResult[i]==',' && flag1==1 && flag2==1)
            {
                ...
                noOfDays = Double.toString(Double.parseDouble(noOfDays)/30);
                c.setItemid(itemid);
        ...
        request.getSession().setAttribute("EDA_MONTHS_OBJECT", edaObject);
        ...
        response.sendRedirect("/MBA2/Manager/ExpiryDateAnalysisMonthsResult.jsp");
