...
public class ReplayAttackCheckGetter extends TransactionHelper
{
    ...
    public void serviceRequest(Map<String, String> requestDataMap, TransactionStatus ts, Map<String, Object> transactionObjects)
    {
        ...
        System.out.println("inside the replay attack getter");
        ...
        if (dBConnection != null)
        {
            try
            {
                ...
                {
                    boolean rs = dBConnection.runUpdateQuery("Update_Manager_Last_Transaction_Time", new String[]{requestDataMap.get("date"),requestDataMap.get("username")});
                    if(rs)
                    {
