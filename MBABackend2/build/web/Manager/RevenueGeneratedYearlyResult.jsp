<%-- 
    Document   : RevenueGeneratedYearlyResult
    Created on : 3 May, 2011, 12:04:06 AM
    Author     : VISHAL
--%>
...
<%
            String dailydate = (String)session.getAttribute("RG_YEARLY_DATE");
            String output = (String)session.getAttribute("RG_YEARLY");
