 ...
 * @author VISHAL
 */
public class CategorySalesAnalysisMonthly
{
    public static String categorySalesAnalysisMonthlyResult = "";
    ...
    {
        categorySalesAnalysisMonthlyResult = "";
        ...
        if(dBConnection != null)
        {
            try
            {
                System.out.println(" I am in Category Sales Analysis Monthly Servlet");
                ...
                ResultSet resultset = dBConnection.runQuery("Fetch_Category_Sales_Analysis_Monthly", new String[]{requestDataMap.get("category"), requestDataMap.get("dailydate")});

                while(resultset.next())
                {
                    categorySalesAnalysisMonthlyResult = categorySalesAnalysisMonthlyResult + resultset.getString("itemid") + "-" + resultset.getString("item_name") + "-" + resultset.getString("category") + "-" + resultset.getString("quantity") + "," ;
                }

                System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkkkk" + categorySalesAnalysisMonthlyResult);
