...
public class FormLogin implements CommandListener
{
     ...
     private boolean validLogin()
    {
        try
        {
            ...
            HttpConnection con = (HttpConnection) Connector.open("http://localhost:8084/MBA/Login?requestsourceid=1&serviceid=1&username="+ tlog.getString()+ "&password="+tpass.getString());
    ...
    public void commandAction(Command c, Displayable d)
    {
        if(d==flogin)
        {
            ...
            else if(c==back)
            {
                ...
                MobileMidlet1.switchDisplay(formhttpsms);
            }
        }
    }
