<%-- 
    Document   : ProductSalesAnalysisMonthlyResult
    Created on : 2 May, 2011, 11:26:04 PM
    Author     : VISHAL
--%>
...
<%
Map<String, ProductSalesAnalysisObject> c = (Map<String, ProductSalesAnalysisObject>)request.getSession().getAttribute("PSA_MONTHLY_OBJECT");
