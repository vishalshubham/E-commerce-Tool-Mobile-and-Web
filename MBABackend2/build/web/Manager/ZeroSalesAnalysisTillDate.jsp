<%-- 
    Document   : ZeroSalesAnalysisTillDate
    Created on : 3 May, 2011, 8:06:41 PM
    Author     : VISHAL
--%>
...
<table width="770" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Zero sales Till Date :</h2></td>
  </tr>
</table>
<!-- Heading Table End -->

 <form action="/MBA2/htmlzerosalesanalysistilldate">
Threshold Value : <input type="text" id="threshold" name="threshold"/>
           <input type="hidden" id="serviceid" name="serviceid" value="31"/>
