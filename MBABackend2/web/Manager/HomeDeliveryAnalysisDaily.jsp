<%-- 
    Document   : HomeDeliveryCallsDaily
    Created on : 3 May, 2011, 10:45:15 PM
    Author     : VISHAL
--%>
...
<form action="/MBA2/htmlhomedeliveryanalysisdaily">
           <input type="hidden" id="serviceid" name="serviceid" value="27"/>
