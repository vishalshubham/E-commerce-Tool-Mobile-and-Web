<%--
    Document   : CategorySalesAnalysis
    Created on : 2 May, 2011, 2:35:40 PM
    Author     : VISHAL
--%>
...
<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href='/MBA2/htmlcategorysalesanalysismenu?category=<%= ct.get(i) %>' ><img src="images/category/<%= ct.get(i) %>.png" width="100" height="150" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href='/MBA2/htmlcategorysalesanalysismenu?category=<%= ct.get(i) %>' ><%=  ct.get(i)  %></a></td>
  </tr>
</table>
