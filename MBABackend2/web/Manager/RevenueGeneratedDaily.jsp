<%-- 
    Document   : RevenueGeneratedDaily
    Created on : 2 May, 2011, 11:59:34 PM
    Author     : VISHAL
--%>
...
<!-- Heading Table End -->
 ...
 <form action="/MBA2/htmlrevenuegenerateddaily">
           <input type="hidden" id="serviceid" name="serviceid" value="33"/>
