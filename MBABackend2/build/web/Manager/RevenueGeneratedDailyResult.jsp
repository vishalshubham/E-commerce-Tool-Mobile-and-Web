<%-- 
    Document   : RevenueGeneratedDailyResult
    Created on : 3 May, 2011, 12:02:51 AM
    Author     : VISHAL
--%>
...
<%
            String dailydate = (String)session.getAttribute("RG_DAILY_DATE");
            String output = (String)session.getAttribute("RG_DAILY");
