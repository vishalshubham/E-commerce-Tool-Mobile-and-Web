 ...
 * @author VISHAL
 */
public class FormCategorySalesAnalysisMenu implements CommandListener
{
    ...
    {
        FormCategorySalesAnalysisMenu fm = new FormCategorySalesAnalysisMenu();
    ...
    public void commandAction(Command c, Displayable d)
    {
            if(c==List.SELECT_COMMAND)
            {
                ...
                formmenucategory = FormCategorySalesAnalysisTimePeriod.getFormCategorySalesAnalysisTimePeriod();
                item = fmenu.getString(fmenu.getSelectedIndex());
                MobileMidlet.switchDisplay(formmenucategory);
