<%-- 
    Document   : ZeroSalesAnalysisDaily
    Created on : 3 May, 2011, 7:45:18 PM
    Author     : VISHAL
--%>
...
<table width="770" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Zero Sales Daily :</h2></td>
  </tr>
</table>
<!-- Heading Table End -->

<form action="/MBA2/htmlzerosalesanalysisdaily">
           <input type="hidden" id="serviceid" name="serviceid" value="32"/>
