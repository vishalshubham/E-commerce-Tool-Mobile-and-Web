 ...
 * @author VISHAL
 */
public class ProductSalesAnalysisMonthly
{
    public static String productSalesAnalysisMonthlyResult = "";
...
productSalesAnalysisMonthlyResult = "";
        if(dBConnection != null)
        {
            try
            {
                System.out.println(" I am in Product Sales Analysis Monthly Servlet");
                ...
                ResultSet resultset = dBConnection.runQuery("Fetch_Product_Sales_Analysis_Monthly", new String[]{requestDataMap.get("item"), requestDataMap.get("category"), requestDataMap.get("dailydate")});

                while(resultset.next())
                {
                    productSalesAnalysisMonthlyResult = productSalesAnalysisMonthlyResult + resultset.getString("itemid") + "-" + resultset.getString("item_name") + "-" + resultset.getString("category") + "-" + resultset.getString("quantity") + "," ;
                }

                System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkkkk" + productSalesAnalysisMonthlyResult);
