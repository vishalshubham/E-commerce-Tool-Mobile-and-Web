<%-- 
    Document   : ProductSalesAnalysisMonthly
    Created on : 2 May, 2011, 10:52:54 PM
    Author     : VISHAL
--%>
...
<form action="/MBA2/htmlproductsalesanalysismonthly">
           <input type="hidden" id="serviceid" name="serviceid" value="25"/>
