<%-- 
    Document   : ProductSalesAnalysisDailyResult
    Created on : 2 May, 2011, 11:06:55 PM
    Author     : VISHAL
--%>
...
<%
            Map<String, ProductSalesAnalysisObject> c = (Map<String, ProductSalesAnalysisObject>)request.getSession().getAttribute("PSA_DAILY_OBJECT");
