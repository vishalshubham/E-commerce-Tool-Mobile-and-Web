<%-- 
    Document   : HomeDeliveryAnalysisYearlyResult
    Created on : 3 May, 2011, 10:59:16 PM
    Author     : VISHAL
--%>
...
<table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Home Delivery : Yearly Report</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
        ...
        <%
            Map<String, HomeDeliveryAnalysisObject> c = (Map<String, HomeDeliveryAnalysisObject>)request.getSession().getAttribute("HDA_YEARLY_OBJECT");
               ...
               while(cset.hasNext())
                {
                    ...
                    <table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="ItemHeading"><h3>Graphical Representation : Yearly Home Delivery</h3></td>
                  </tr>
                </table>
                  <center>
                  <img src="../../images/HomeDeliveryAnalysisYearly/myimg.jpg" alt="Image 0" />
                  </center>
