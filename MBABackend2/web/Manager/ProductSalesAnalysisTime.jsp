<%-- 
    Document   : ProductSalesAnalysisTime
    Created on : 2 May, 2011, 10:50:38 PM
    Author     : VISHAL
--%>
...
<%
            ...
            String item = (String)session.getAttribute("PSA_ITEM");
        %>
...
<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href="/MBA2/Manager/ProductSalesAnalysisDaily.jsp"><img src="images/time/Daily.jpg" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href="/MBA2/Manager/ProductSalesAnalysisDaily.jsp">Daily Analysis</a></td>
  </tr>
</table>

<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href="/MBA2/Manager/ProductSalesAnalysisMonthly.jsp"><img src="images/time/Monthly.jpg" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href="/MBA2/Manager/ProductSalesAnalysisMonthly.jsp">Monthly Analysis</a></td>
  </tr>
</table>

<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href="/MBA2/Manager/ProductSalesAnalysisYearly.jsp"><img src="images/time/Yearly.jpg" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href="/MBA2/Manager/ProductSalesAnalysisYearly.jsp">Yearly Analysis</a></td>
  </tr>
</table>
...
<html>
    ...
    <body>
        ...
        <center>
        <a href="/MBA2/Manager/ProductSalesAnalysisDaily.jsp" >Daily Analysis</a><br>
        <a href="/MBA2/Manager/ProductSalesAnalysisMonthly.jsp" >Monthly Analysis</a><br>
        <a href="/MBA2/Manager/ProductSalesAnalysisYearly.jsp" >Yearly Analysis</a><br>
        </center>
