<%-- 
    Document   : RevenueGeneratedYearly
    Created on : 3 May, 2011, 12:01:08 AM
    Author     : VISHAL
--%>
...
<form action="/MBA2/htmlrevenuegeneratedyearly">
           <input type="hidden" id="serviceid" name="serviceid" value="35"/>
