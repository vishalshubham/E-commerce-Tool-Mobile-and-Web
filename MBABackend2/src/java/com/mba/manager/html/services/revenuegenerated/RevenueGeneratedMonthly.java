...
package com.mba.manager.html.services.revenuegenerated;
 ...
 * @author VISHAL
 */
public class RevenueGeneratedMonthly extends HttpServlet {
    ...
    throws ServletException, IOException
    {
        ...
        request.getSession().setAttribute("RG_MONTHLY_DATE", dailydate);
        request.getSession().setAttribute("RG_MONTHLY", finalResult);
        ...
        response.sendRedirect("/MBA2/Manager/RevenueGeneratedMonthlyResult.jsp");
