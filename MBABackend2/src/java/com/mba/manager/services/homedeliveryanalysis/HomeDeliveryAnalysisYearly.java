 ...
 * @author VISHAL
 */
public class HomeDeliveryAnalysisYearly
{
    public static String homeDeliveryAnalysisYearlyResult = "";
    public static TransactionStatus getDailyReport(Map<String, String> requestDataMap, TransactionStatus ts, Map<String, Object> transactionObjects)
    {
        ...
        homeDeliveryAnalysisYearlyResult = "";
        if(dBConnection != null)
        {
            try
            {
                System.out.println(" I am in Home Delivery Analysis Yearly Servlet");
                ...
                ResultSet resultset = dBConnection.runQuery("Fetch_Home_Delivery_Analysis_Yearly", new String[]{requestDataMap.get("dailydate")});

                while(resultset.next())
                {
                    homeDeliveryAnalysisYearlyResult = homeDeliveryAnalysisYearlyResult + resultset.getString("way") + "-" + resultset.getString("total") + "," ;
                }

                System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkkkk" + homeDeliveryAnalysisYearlyResult);
