<%--
    ...
    Created on : 9 Mar, 2011, 11:09:20 PM
    Author     : VISHAL
--%>
...
<table width="800" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Click Here to See your Order List :</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<table width="750" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
  <tr class="ItemHeading">
    <td width="88" align="center">Click Here : </td>
     </tr>
    <tr>
    <td align="center"><span class="ItemDetail">

            <form action="http://localhost:8084/MBA/OrderList">
                ...
                <input type="submit" value="Check your Ordered Carts"/>
            </form>
