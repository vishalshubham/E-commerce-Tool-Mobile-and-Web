<%-- 
    Document   : ZeroSalesAnalysis
    Created on : 2 May, 2011, 2:36:39 PM
    Author     : VISHAL
--%>
...
<table width="770" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Zero Sales :</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href="/MBA2/Manager/ZeroSalesAnalysisDaily.jsp"><img src="images/time/Zerosalesdaily.jpg" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href="/MBA2/Manager/ZeroSalesAnalysisDaily.jsp">Daily Zero Sales</a></td>
  </tr>
</table>

<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href="/MBA2/Manager/ZeroSalesAnalysisTillDate.jsp"><img src="images/time/zerosalestilldate.jpg" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href="/MBA2/Manager/ZeroSalesAnalysisTillDate.jsp">Till Date Analysis</a></td>
  </tr>
</table>
...
<map name="Social">
  ...
  <area shape="rect" coords="749,58,797,105" href="http://www.youtube.com/" target="_blank">
        ...
        <a href="/MBA2/Manager/ZeroSalesAnalysisDaily.jsp" >On a Particular Date</a><br>
        <a href="/MBA2/Manager/ZeroSalesAnalysisTillDate.jsp" >Till Today's Date</a><br>
