<%--
    Document   : ProductSalesAnalysisItemList
    Created on : 2 May, 2011, 10:33:53 PM
    Author     : VISHAL
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.ArrayList" %>
<%@page import="com.mba.manager.Item.ItemObject" %>
<%@page import="com.mba.manager.Item.ItemListGetter" %>
...
<%
        ArrayList<ItemObject> ct = ItemListGetter.getItemList(request.getParameter("category"));
%>
...
<table width="100" height="180" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td height="150" class="AllBorderTable"><a href='/MBA2/htmlproductsalesanalysisitem?item=<%= itemId %>' ><img src="images/itemlist/<%= itemName %>.jpg" width="100" height="150" border="0"></a></td>
  </tr>
  <tr>
    <td class="ItemHeading" align="center"><a href='/MBA2/htmlproductsalesanalysisitem?item=<%= itemId %>' ><%=  itemName  %></a></td>
  </tr>
</table>
