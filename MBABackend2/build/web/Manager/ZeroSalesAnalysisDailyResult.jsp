<%-- 
    Document   : ZeroSalesAnalysisDailyResult
    Created on : 3 May, 2011, 7:55:09 PM
    Author     : VISHAL
--%>
...
<table width="750" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="ItemHeading"><h2>Zero Sales : Daily Report</h2></td>
  </tr>
</table>
<!-- Heading Table End -->
...
<%
            Map<String, ZeroSalesAnalysisObject> c = (Map<String, ZeroSalesAnalysisObject>)request.getSession().getAttribute("ZSA_DAILY_OBJECT");
