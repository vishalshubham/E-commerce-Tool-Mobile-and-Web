 ...
 * @author VISHAL
 */
public class HomeDeliveryAnalysisDaily
{

    public static String homeDeliveryAnalysisDailyResult = "";
    public static TransactionStatus getDailyReport(Map<String, String> requestDataMap, TransactionStatus ts, Map<String, Object> transactionObjects)
    {
        ...
        homeDeliveryAnalysisDailyResult = "";
        if(dBConnection != null)
        {
            try
            {
                System.out.println(" I am in Home Delivery Analysis Daily Servlet");
                ...
                ResultSet resultset = dBConnection.runQuery("Fetch_Home_Delivery_Analysis_Daily", new String[]{requestDataMap.get("dailydate")});

                while(resultset.next())
                {
                    homeDeliveryAnalysisDailyResult = homeDeliveryAnalysisDailyResult + resultset.getString("way") + "-" + resultset.getString("total") + "," ;
                }

                System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkkkk" + homeDeliveryAnalysisDailyResult);
